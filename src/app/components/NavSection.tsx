    ...
    >
      <div className="flex flex-col md:flex-row justify-between p-4 md:px-10 box-container">
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
          ...
          <Link href="/blogs"><button className="text-white text-sm rounded-full px-10 py-2 transition-all duration-300 hover:bg-blue-500 hover:text-white bg-blue-500 bg-opacity-5">
              Blogs
            </button></Link>
